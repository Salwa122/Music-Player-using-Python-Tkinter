...
class Player(tk.Frame):
    def __init__(self, master):
        super().__init__(master, bg="black", highlightbackground="black", highlightthickness=0)
        self.master = master
        self.pack()

        default_songs = [
            "Music/Aashiq Tera.mp3",
            ...
            "Music/Criminal.mp3",
            "Music/Dafa 406.mp3",
            "Music/Ek Pal Ka Jeena.mp3 ",
            "Music/Ilahi - Arijit Singh.mp3",
            "Music/Ishq Shava.mp3",
            "Music/Kabhi Kabhi Aditi.mp3",
            "Music/khairiyat.mp3",
            "Music/Khalasi.mp3",
            "Music/Naacho Naacho - RRR.mp3",
            "Music/Sab Tera - Baaghi.mp3",
            "Music/Tum Hi Aana.mp3",
            "Music/Ude Dil Befikre.mp3",
            "Music/Udhal Ho - Malaal.mp3",
            "Music/Uska Hi Banana.mp3",
            "Music/Ved Tujha - Ved.mp3"
        ]
        
        self.playlist = default_songs
        self.image_paths = [
                            "images/aashiq tera.gif",
    ...
    def create_frames(self):
        self.track = tk.LabelFrame(self, text='Track',
                                   ...
                                   bg="#0c0c0c", fg="white", bd=3 ,relief=tk.GROOVE)
    ...
    def update_playlist(self):
        ...
        for song_path in self.playlist:
            ...
            song_name_with_space = f' {song_name}'
    ...
    def play_music(self):
        if self.playlist:
            ...
            self.after(100, self.check_music_finished)
...
root = tk.Tk()
root.geometry('670x442')
root.wm_title('Music Player')
root.configure(bg='black')
root.config(pady=2)
root.resizable(False, False) 
img = PhotoImage(file='images/guitar.gif')
next = PhotoImage(file='images/nexticon.gif')
prev = PhotoImage(file='images/previousicon.gif')
pause = PhotoImage(file='images/pauseicon.gif')
play = PhotoImage(file='images/playicon.gif')
download = PhotoImage(file='images/downloadicon.gif')
